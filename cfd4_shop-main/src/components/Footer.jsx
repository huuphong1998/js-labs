                    ...
                    <div className="row">
                        ...
                        <div className="col-6 col-sm">
                            ...
                            <ul className="list-unstyled mb-7 mb-sm-0">
                                <li>
                                    <Link className="text-gray-300" to="./contact-us.html">Contact Us</Link>
                                </li>
                                <li>
                                    <Link className="text-gray-300" to="./faq.html">FAQs</Link>
                                </li>
                                <li>
                                    <Link className="text-gray-300" data-toggle="modal" to="#modalSizeChart">Size Guide</Link>
                                </li>
                                <li>
                                    <Link className="text-gray-300" to="./shipping-and-returns.html">Shipping &amp; Returns</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="col-6 col-sm">
                            ...
                            <ul className="list-unstyled mb-7 mb-sm-0">
                                <li>
                                    <Link className="text-gray-300" to="./shop.html">Men's Shopping</Link>
                                </li>
                                <li>
                                    <Link className="text-gray-300" to="./shop.html">Women's Shopping</Link>
                                </li>
                                <li>
                                    <Link className="text-gray-300" to="./shop.html">Kids' Shopping</Link>
                                </li>
                        ...
                        <div className="col-6 col-sm">
                            ...
                            <ul className="list-unstyled mb-0">
                                <li>
                                    <Link className="text-gray-300" to="./about.html">Our Story</Link>
                                </li>
                                <li>
            ...
            <div className="py-6">
                <div className="container">
                    <div className="row">
                        <div className="col">
                            {/* Copyright */}
                            <p className="mb-3 mb-md-0 font-size-xxs text-muted"> © 2019 All rights reserved. Designed by Unvab. </p>
                        </div>
                        <div className="col-auto">
                            {/* Payment methods */}
